...
class DataValidation:
    ...
    # Validating schema columns for Train and Test Dataframe
    ...
    # Validating numerical columns for Train and Test Dataframe
    ...
    # Validating categorical columns for Train and Test Dataframe
